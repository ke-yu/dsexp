...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 48; i <= 57; ++i) start[i] = 29;
		start[34] = 7; 
		start[39] = 9; 
		start[46] = 30; 
		start[64] = 31; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 9:
				...
				else if (ch == 92) {AddCh(); goto case 36;}
				else {goto case 0;}
			case 10:
			...
			case 26:
				...
				if (ch <= 9 || ch >= 11 && ch <= 65535) {AddCh(); goto case 26;}
			...
			case 37:
				if (ch <= ')' || ch >= '+' && ch <= '.' || ch >= '0' && ch <= 65535) {AddCh(); goto case 27;}
